        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                	...
                	<p>Imprisoned on the other side of the universe, the mighty Thor (Chris Hemsworth) finds himself in a deadly gladiatorial contest that pits him against the Hulk (Mark Ruffalo), his former ally and fellow Avenger.</p>
                ...
                <div class="col-sm-6"><div class="embed-responsive embed-responsive-16by9">
                 ...
                 <a href="C:\xampp\htdocs\OnlineStream\images\Thor Ragnarok Teaser Trailer [HD].mp4" class="btn btn-default btn-lg">See The Trailer</a>
                </div></div>
            </div>     	
    </section>
	<!-- Content 2 -->
